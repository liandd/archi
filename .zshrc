...
export PATH="$PATH:/usr/sbin:/opt:/home/blyaat/.local/bin"

eval "$(oh-my-posh init zsh --config /home/blyaat/.config/ohmyposh/pure.json)"
...
function settarget(){
    ip_address=$1
    machine_name=$2
    echo "$ip_address $machine_name" > /home/blyaat/.config/polybar/scripts/.target.tmp
}

function cleartarget(){
	echo '' > /home/blyaat/.config/polybar/scripts/.target.tmp
}
...
#export PATH="$PATH:/usr/sbin:/opt:~/.ruby/bin:/home/blyaat/.local/share/gem/ruby/3.2.0/bin/"
#export PATH="$PATH:/usr/sbin:/opt:/home/blyaat/.local/bin"
